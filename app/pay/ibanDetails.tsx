...
const IbanDetails = ({
    ...
    // console.group('Monerium data in Details Section')
                ...
                {orders?.map((order) => {
                    ...
                    return (
                        <div className='flex flex-col gap-2 cursor-pointer '>
                            <div onClick={() => handleDisplayOrder(order.id)} className='flex flex-row rounded-md justify-between border cursor-pointer font-500 text-lg tracking-tight px-4 py-2'>
                            ...
                            <div className={`${displayId == order.id ? 'flex' : 'hidden'} md:flex-row flex-col px-4 py-2 gap-8 border rounded-md`}>
                                <div className='flex flex-col gap-2 flex-1'>
                                    ...
                                    <div className='flex flex-row justify-between'>
                                        ...
                                        <div className='text-sm font-400 text-grey-400'>
                                            <Address address={order.txHashes[0]} />
                                        </div>
                                    </div>
                                    <div className='flex flex-row justify-between'>
